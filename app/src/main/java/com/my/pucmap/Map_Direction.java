...
public class Map_Direction extends FragmentActivity implements OnMapReadyCallback, DirectionFinderListener {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.moveCamera(CameraUpdateFactory.newLatLngZoom(pula, 18));
